...
<div style="display: flex; justify-content: space-between;">
  <div style="width: 48%; text-align: center;">
    <img src="https://velog.velcdn.com/images/kgh67811/post/2ceff966-7a3f-44fe-98b7-c66110a3372d/image.png" alt="첫 번째 이미지 설명" style="max-width: 100%; height: auto;"/>
    <p style="margin-top: 5px; font-size: 0.9em;">"Not" 글자가 폰트 로드로 인해 보이지 않습니다.</p>
  </div>

  <div style="width: 48%; text-align: center;">
    <img src="https://velog.velcdn.com/images/kgh67811/post/bb270594-1452-4a74-b28c-0c7e5dbee85b/image.png" alt="두 번째 이미지 설명" style="max-width: 100%; height: auto;"/>
    <span style="margin-top: 5px; font-size: 0.9em; display: block;">폰트가 로드 되고 나서야 "Not"글자가 보입니다.</span>
  </div>
</div>
...
<div style="display: flex; flex-direction: column; align-items: center; width: 300px; margin: 0 auto; border: 1px solid #ddd;">
  <div>
    <img
...
<div style="display: flex; justify-content: center; align-items:center; flex-direction: column;">
  <img
    ...
    alt="woff2 지원 여부"
    style="max-width: 80%; 	height: 80%; display:block;"
  />
  <p style="text-align: center; color: #8e8e8e;">
...
<div style="display: flex; justify-content: center; align-items:center; flex-direction: column;">
  <img
    ...
    style="max-width: 80%; height: 80%; display:block;"
  />
  <p style="text-align: center; color: #8e8e8e;">woff2의 전체 파일 용량의 1/3 수준입니다.</p>
</div>
